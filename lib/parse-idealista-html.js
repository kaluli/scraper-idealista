...
function extractFromTitle(pageTitle) {
  ...
  // Alcalá de Henares y otras ciudades de la Comunidad de Madrid → province Madrid
  if (province && /alcalá\s*de\s*henares|getafe|alcobendas|las\s*rozas|móstoles|fuenlabrada/i.test(province)) {
    province = 'Madrid'
  }
