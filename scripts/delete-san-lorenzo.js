...
async function deleteSanLorenzo() {
  try {
    console.log('🗑️  Eliminando todos los pisos de San Lorenzo...\n');

    // Buscar todos los pisos de San Lorenzo
    ...
    if (listingsToDelete.length === 0) {
      console.log('⚠️  No hay pisos de San Lorenzo para eliminar.');
      return;
    }
    ...
    if (remaining > 0) {
      console.log(`\n⚠️  Aún quedan ${remaining} pisos de San Lorenzo.`);
    } else {
      console.log(`\n✅ Todos los pisos de San Lorenzo han sido eliminados.`);
    }
